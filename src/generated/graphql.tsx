...
export function useMessagesQuery(
  baseOptions?: Apollo.QueryHookOptions<SchemaTypes.MessagesQuery, SchemaTypes.MessagesQueryVariables>
) {
  return Apollo.useQuery<SchemaTypes.MessagesQuery, SchemaTypes.MessagesQueryVariables>(MessagesDocument, baseOptions);
}
export function useMessagesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<SchemaTypes.MessagesQuery, SchemaTypes.MessagesQueryVariables>
) {
  return Apollo.useLazyQuery<SchemaTypes.MessagesQuery, SchemaTypes.MessagesQueryVariables>(
    MessagesDocument,
    baseOptions
  );
}
...
export function refetchMessagesQuery(variables?: SchemaTypes.MessagesQueryVariables) {
...
export function refetchRoomQuery(variables?: SchemaTypes.RoomQueryVariables) {
...
export function refetchRoomsQuery(variables?: SchemaTypes.RoomsQueryVariables) {
...
export const SendersDocument = gql`
  query senders($ids: [UUID_NAMEID_EMAIL!]!) {
    usersById(IDs: $ids) {
      id
      displayName
    }
...
export function refetchSendersQuery(variables?: SchemaTypes.SendersQueryVariables) {
  return { query: SendersDocument, variables: variables };
}
...
export function useOnMessageReceivedSubscription(
  ...
  return Apollo.useSubscription<
    SchemaTypes.OnMessageReceivedSubscription,
    SchemaTypes.OnMessageReceivedSubscriptionVariables
  >(OnMessageReceivedDocument, baseOptions);
}
